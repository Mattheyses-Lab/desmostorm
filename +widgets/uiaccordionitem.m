...
properties
    ...
    expandedIconLight (1,:) char = app.Paths.icons('CollapseWhiteIcon.png')
    collapsedIconLight (1,:) char = app.Paths.icons('ExpandWhiteIcon.png')
    expandedIconDark (1,:) char = app.Paths.icons('CollapseIcon.png')
    collapsedIconDark (1,:) char = app.Paths.icons('ExpandIcon.png')
end
...
methods(Access=protected)
    ...
    function setup(obj)
        ...
        obj.titleIcon = uiimage(obj.itemGrid,...
            ...
            "ImageSource",app.Paths.icons('ExpandIcon.png'),...
            "Tag","TitleBar",...
            "UserData",obj.ID);
...
methods
    ...
    function buttonIcon = get.buttonIcon(obj)
        if isequal(utils.getBWContrastColor(obj.TitleBackgroundColor),[0 0 0])
            if obj.expanded
