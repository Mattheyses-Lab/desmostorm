classdef DrawRectangle < widgets.ImageAxesTool
% widgets.tools.DrawRectangle - draw a rectangle in the Host axes using images.roi.Rectangle
    ...
    methods
        ...
        function obj = DrawRectangle(host)
            obj@widgets.ImageAxesTool(host, "DrawRectangle",...
                'Tooltip','Draw scan area',...
                'Icon',app.Paths.icons('RectangleROIIcon.png'),...
                'Priority',10,...
                'IsExclusive',true,...
                'CapturesDown',true,...
                'CapturesUp',true,...
    ...
    methods (Access=private)
        ...
        function [WidthMidline,XRay,ArcPolyline,LabelPosition] = getAnnotationData(obj)
            ...
            ML  = utils.getMidpoint(V(1,:),V(2,:));
            % right segment midpoint between vertices 3 and 4 -> [x2, y2]
            MR = utils.getMidpoint(V(3,:),V(4,:));
