classdef Pick < widgets.ImageAxesTool
% widgets.tools.Pick - optimistic box creation on click
    ...
    properties (Access = private, Transient, NonCopyable)
        BoxROI (:,1) widgets.overlays.ROIBox
    end
    ...
    methods
        function obj = Pick(host)
            obj@widgets.ImageAxesTool(host, "Pick",...
                'Tooltip','Pick regions',...
                'Icon',app.Paths.icons('AddRectangleIcon.png'),...
                'Priority',10,...
                'IsExclusive',true,...
                'CapturesDown',true,...
                'DistractsDown',true,...
            ...
            obj.BoxROI = widgets.overlays.ROIBox.empty();
